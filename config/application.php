 ...
 */
env( 'FLUENTMAIL_GMAIL_CLIENT_ID' ) && env( 'FLUENTMAIL_GMAIL_CLIENT_SECRET' ) && (
...
env( 'FLUENTMAIL_SMTP_USERNAME' ) && env( 'FLUENTMAIL_SMTP_PASSWORD' ) && (
 ...
 * HDA Plugin
 *
 * HDA_GITHUB_TOKEN             - GitHub token for auto-updates
 * HDA_DISABLE_OTP              - Emergency: bypass OTP only
 * HDA_DISABLE_LOGIN_SECURITY   - Emergency: bypass ALL login security
 * HDA_DISABLE_LOGIN_CAPTCHA    - Emergency: bypass login CAPTCHA
 */
