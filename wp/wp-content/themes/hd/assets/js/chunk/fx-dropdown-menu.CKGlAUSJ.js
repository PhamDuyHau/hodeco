import { $ as $$, o as off, E as Events, a as on, c as createWeakStore } from "../vendor.BOa7rJol.js";
...
const FxDropdownMenu = {
  ...
  initMenu(menu, useHover = ((_a) => (_a = menu.dataset) == null ? void 0 : _a.hover)() === "true") {
    ...
    menu.querySelectorAll("li").forEach((li) => {
      ...
      if (!sub || !btn) {
        ...
        btn == null ? void 0 : btn.setAttribute("role", "menuitem");
        return;
      }
  ...
  initAutoHide(menu) {
    ...
    const createMoreAndInit = () => {
      ...
      more.innerHTML = '<a href="#" role="menuitem" aria-haspopup="true" aria-expanded="false">More</a><ul class="submenu vertical menu is-dropdown-submenu"></ul>';
    ...
    (((_a = document.fonts) == null ? void 0 : _a.ready) || Promise.resolve()).then(() => {
      invalidateCache();
  ...
  destroyAll(root = document) {
    $$(ROOT, root).forEach((menu) => {
      var _a;
      (_a = this._observers.get(menu)) == null ? void 0 : _a.disconnect();
      this._observers.delete(menu);
      menu.querySelectorAll("li").forEach((li) => {
        const h = this._handlers.get(li);
        if ((h == null ? void 0 : h.type) === "hover") {
        ...
        if ((c == null ? void 0 : c.type) === "click") off(btn, "click", c.handler);
...
export {
  FxDropdownMenu as default
};
//# sourceMappingURL=fx-dropdown-menu.CKGlAUSJ.js.map
