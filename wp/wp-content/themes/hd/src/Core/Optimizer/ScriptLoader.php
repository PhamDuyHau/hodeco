...
final class ScriptLoader {
	...
	public static function register(): void {
		add_filter( 'script_loader_tag', self::scriptLoaderTag( ... ), 12, 3 );
		add_filter( 'style_loader_tag', self::styleLoaderTag( ... ), 12, 2 );
		add_action( 'wp_body_open', self::printLazyStyles( ... ), 1 );
	}
