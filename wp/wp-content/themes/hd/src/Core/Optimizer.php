 ...
 *
 * Note: Cleanup functionality has been moved to HDA plugin (Optimize module).
 *
...
use HD\Core\Optimizer\CssClass;
use HD\Core\Optimizer\ImageSize;
use HD\Core\Optimizer\ScriptLoader;
...
final class Optimizer {
	...
	/**
	 * Configure permalink structure (one-time).
	 *
	 * @return void
	 */
	private function configurePermalink(): void {
