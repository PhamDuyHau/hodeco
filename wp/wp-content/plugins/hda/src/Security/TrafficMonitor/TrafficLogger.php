...
final class TrafficLogger {
	 ...
	 */
	public const string TABLE_NAME = 'hda_traffic_logs';

	/**
	 * Maximum logs to keep (hard cap prevents runaway growth).
	 */
	private const int MAX_LOGS = 100_000;
	...
	public static function getStats( int $days = 7 ): array {
		if ( ! self::tableExists() ) {
			return [ 'total' => 0, 'blocked' => 0, 'logged' => 0, 'by_type' => [], 'top_ips' => [] ];
		}
