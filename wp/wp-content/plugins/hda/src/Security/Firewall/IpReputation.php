...
final class IpReputation {
	 ...
	 */
	private const string CACHE_DROP    = 'hda_fw_blocklist_drop';
	private const string CACHE_EDROP   = 'hda_fw_blocklist_edrop';
	private const string CACHE_ET      = 'hda_fw_blocklist_et';
