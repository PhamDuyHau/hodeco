 ...
 *
 * @package HDAddons\LoginSecurity\Totp
 * @author  HD
 */

namespace HDAddons\LoginSecurity\Totp;
...
final class TotpHandler {
	...
	public const int    PERIOD      = 30;     // Time step in seconds.
	public const int    DIGITS      = 6;      // Code length.
	public const string ALGO        = 'sha1'; // HMAC algorithm.
	public const int    SECRET_LEN  = 20;     // Random bytes for secret.
	public const int    WINDOW      = 1;      // ±1 time step tolerance.

	// ─── Database ────────────────────────────────────────────
	public const string TABLE_NAME = 'hda_totp_secrets';
	...
	/**
	 * Get the user's Base32 secret (or empty string).
	 *
	 * @param int $userId WordPress user ID.
	 *
	 * @return string
