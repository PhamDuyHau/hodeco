...
namespace HDAddons\Recaptcha\Provider;
...
final class RecaptchaV2Provider implements CaptchaProviderInterface {
	 ...
	 * @param bool   $useGlobalDomain Use recaptcha.net instead of google.com.
	 */
	public function __construct(
		private readonly string $siteKey,
		private readonly string $secretKey,
		private readonly bool $useGlobalDomain = false,
	) {}
	...
	public function enqueueAssets(): void {
		$domain = $this->useGlobalDomain ? 'recaptcha.net' : 'google.com';

		wp_enqueue_script(
			'hda-recaptcha-v2',
			"https://www.{$domain}/recaptcha/api.js",
			[],
			null,
			true
		);
