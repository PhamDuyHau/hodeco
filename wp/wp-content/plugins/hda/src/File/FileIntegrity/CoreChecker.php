...
final class CoreChecker {
	 ...
	 */
	private const string CHECKSUMS_API = 'https://api.wordpress.org/core/checksums/1.0/';

	/**
	 * Transient key for cached checksums.
	 */
	private const string CACHE_KEY = 'hda_wp_core_checksums';
	 ...
	 */
	private const array CORE_DIRS = [ 'wp-admin', 'wp-includes' ];
